...
void first()
{
	...
	glColor3f(0.75, 0.75, 0.75);
	strokeString(50, 850, 0.15, 0.15, "YENEPOYA INSTITUTE OF TECHNOLOGY", 2);
	strokeString(100, 750, 0.3, 0.3, "DEPARTMENT OF COMPUTER SCIENCE", 4);
	strokeString(300, 670, 0.3, 0.3, "AND ENGINEERING", 4);
	strokeString(200, 500, 0.3, 0.3, "COMPUTER GRAPHICS", 2);
	glColor3f(0, 0.5, 0.5);
	...
	strokeString(650, 160, 0.18, 0.18, "K Pawan Bangera", 2);
	strokeString(650, 30, 0.2, 0.2, "Soumya S (Associate Professor)", 2);
	strokeString(650, 120, 0.18, 0.18, "4DM20CS020", 2);
	glutSwapBuffers();
}		
